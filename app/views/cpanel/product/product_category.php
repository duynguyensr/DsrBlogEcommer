...
<p>
    ...
    <tr>
        ...
        <td><a href="<?php echo BASE_URL ?>/product/editcategory?id=<?php echo $value['id_category_product'] ?>">Sửa</a> || <a href="<?php echo BASE_URL ?>/product/deletecategory?id=<?php echo $value['id_category_product'] ?>">Xóa</a> </td>
    </tr>
    <?php
    }
    ?>
